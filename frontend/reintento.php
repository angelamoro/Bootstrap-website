            ...
            <form method="post" action="">
                ...
                <div class="form-element">
                    ...
                    <select class="form-control" name="type" id="transactionType">
                        ...
                        <select class="form-control" name="category" id="transactionCategory"></select>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            document.getElementById('transactionType').addEventListener('change', function () {
                var type = this.value;
                var categorySelect = document.querySelector('#transactionCategory');

                // Limpiar opciones existentes
                categorySelect.innerHTML = '';

                // Solo hacer la solicitud AJAX si el tipo es 'Income'
                if (type === 'Income') {
                    // Realizar la solicitud AJAX para obtener las categorías de ingresos
                    var xhr = new XMLHttpRequest();
                    xhr.open('GET', '../php/getIncomeCategories.php', true);
